...
public class UserController {
    ...
    public String list(@RequestParam(required = false) String userName,
                      ...
                      Model model){
        // 获取分页数据
        List<User> users = userService.findByConditionsPaged(userName, realName, phone, status, 0, page, limit);
        int total = userService.countByConditions(userName, realName, phone, status, 0);
    ...
    public Object save(User user){
        ...
        return ok ? java.util.Collections.singletonMap("success", true) : java.util.Collections.singletonMap("success", false);
    }
