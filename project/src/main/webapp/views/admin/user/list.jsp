...
<head>
    ...
    <style>
        ...
        .op-col{width:220px;} /* 操作栏宽度加大 */
    </style>
</head>
<body>
<div class="layui-container" style="padding:20px;">
    <div class="actions">
        <a class="layui-btn layui-btn-normal" href="${pageContext.request.contextPath}/admin/user/add">新增会员</a>
    </div>
    ...
    <table class="layui-table" lay-size="sm">
        ...
        <c:forEach var="u" items="${users}">
            <tr>
                ...
                <td>
                    <a class="layui-btn layui-btn-xs" href="${pageContext.request.contextPath}/admin/user/edit/${u.userId}">编辑</a>
                    <button class="layui-btn layui-btn-danger layui-btn-xs" onclick="deleteUser(${u.userId})">删除</button>
...
<script>
    layui.use(['layer', 'form', 'laypage'], function(){
        ...
        form.on('submit(searchBtn)', function(data){
            ...
            var url = '${pageContext.request.contextPath}/admin/user/list';
        ...
        window.resetPwd = function(id){
            layer.confirm('确定将密码重置为 123456 吗？', function(index){
                fetch('${pageContext.request.contextPath}/admin/user/resetPassword', {
                    method:'POST',
                    headers:{'Content-Type':'application/x-www-form-urlencoded'},
                    body:'userId=' + id
                }).then(r=>r.json()).then(res=>{
